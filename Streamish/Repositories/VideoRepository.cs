    ...
    public class VideoRepository : BaseRepository, IVideoRepository
    {
        ...
        public List<Video> GetAll()
        {
            using (var conn = Connection)
            {
                ...
                {
                    cmd.CommandText = @"SELECT v.Id, v.Title, v.Description, v.Url, v.DateCreated, 
                                        v.UserProfileId, up.Name, up.Email, up.DateCreated AS UserProfileDateCreated,
        ...
        public Video GetById(int id)
        {
            using (var conn = Connection)
            {
                ...
                using (var cmd = conn.CreateCommand())
                {
                    cmd.CommandText = @" SELECT v.Title, v.Description, v.Url, v.DateCreated, v.UserProfileId as VideUserProfileId, 
                                                up.Name, up.Email, up.ImageUrl as UserProfileImageUrl, up.DateCreated as UserProfileDateCreated
                                        FROM Video v
                                        JOIN UserProfile up on up.Id=v.UserProfileId
                                        WHERE v.Id = @Id";
